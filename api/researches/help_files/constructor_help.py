constructor_help_message = [
    ...
    {"label": "-", "param": "#cda#code#days_ago#3", "value": "Искать по cda-коду (разных id-полей) 3 дня назад"},
    {"label": "-", "param": "%root_hosp#cda#code", "value": "Искать в рамках текущей госпитализации по всем отделениям по cda-коду (одинаковый у всех) (разных id-полей)"},
